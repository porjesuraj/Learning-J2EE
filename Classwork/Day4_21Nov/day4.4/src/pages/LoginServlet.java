		...
		try (PrintWriter pw = response.getWriter()) {
			...
			if (authenticateCustomer == null)
               ...
               pw.flush(); // commiting the content to clnt  
				...
				// 2.dynamically include content of category page to login --> category 
				
				rd.include(request, response);
				// http://localhost:8080/day4.2/validate
               System.out.println("after include...");
               pw.print("content after include"); // WC does not clear or discard PW buffers , it invokes category
